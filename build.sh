...
export PATH=${SOURCE_ROOT}/prebuilts/clang/host/linux-x86/clang-r383902/bin:${SOURCE_ROOT}/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin:/usr/bin:/bin:$PATH
